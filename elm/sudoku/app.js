...
var $author$project$Main$rowToTr = function (row) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		$elm$core$Array$toList(
			A2($elm$core$Array$map, $author$project$Main$tileToInput, row)));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$Array$toList(
					A2($elm$core$Array$map, $author$project$Main$rowToTr, model.board)))
			]));
};
